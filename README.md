...
### Running wetter Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start wetter locally by running:
...
Then you can interact with wetter by typing `wetter help`.

    wetter> wetter help
    wetter animate me <query> - The same thing as `image me`, except adds [snip]
    wetter help - Displays all of the help commands that wetter knows about.
    ...
